...
brew install python3 npm nmap tree wget wireguard-tools jq azure-cli

brew install --cask github visual-studio-code
brew install --cask intune-company-portal microsoft-edge microsoft-office microsoft-teams onedrive
